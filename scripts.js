...
function addSubject(){
  ...
  div.innerHTML = `
    ...
    <div class="muted small">Note: Check the failing mark in the setting.if you have less mark than failing mark,then the grade point is zero for the given subject📔.</div>
  `;
